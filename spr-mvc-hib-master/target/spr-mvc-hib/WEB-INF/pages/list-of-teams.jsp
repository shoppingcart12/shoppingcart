...
<tr>
	...
	<td>${team.price}</td>
	<td>
	<a href="${pageContext.request.contextPath}/team/edit/${team.productid}.html">Edit</a><br/>
	<a href="${pageContext.request.contextPath}/team/delete/${team.productid}.html">Delete</a><br/>
	</td>
</tr>
</c:forEach>
</tbody>
